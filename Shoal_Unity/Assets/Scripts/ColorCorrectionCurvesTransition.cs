...
{
	[ExecuteInEditMode]
	[AddComponentMenu ("Image Effects/Color Adjustments/Color Correction Transition(Curves, Saturation)")]
	public class ColorCorrectionCurvesTransition : PostEffectsBase
	{
		...
		public AnimationCurve redChannel2 = new AnimationCurve(new Keyframe(0f,0f), new Keyframe(1f,1f));
		public AnimationCurve greenChannel2 = new AnimationCurve(new Keyframe(0f,0f), new Keyframe(1f,1f));
		public AnimationCurve blueChannel2 = new AnimationCurve(new Keyframe(0f,0f), new Keyframe(1f,1f));
		...
		public void UpdateParameters ()
		{
			...
			if (redChannel != null && greenChannel != null && blueChannel != null)
			{
				...
				{
					float rCh = Mathf.Lerp(Mathf.Clamp (redChannel.Evaluate(i), 0.0f, 1.0f),Mathf.Clamp (redChannel2.Evaluate(i), 0.0f, 1.0f),transition)   ;
					float gCh = Mathf.Lerp(Mathf.Clamp (greenChannel.Evaluate(i), 0.0f, 1.0f),Mathf.Clamp (greenChannel2.Evaluate(i), 0.0f, 1.0f),transition)    ;
					float bCh = Mathf.Lerp(Mathf.Clamp (blueChannel.Evaluate(i), 0.0f, 1.0f), Mathf.Clamp (blueChannel2.Evaluate(i), 0.0f, 1.0f),transition)  ;
