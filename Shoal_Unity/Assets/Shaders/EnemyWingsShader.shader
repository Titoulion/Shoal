...
////// Emissive:
                ...
                float2 node_877 = float2(0.0,(node_3274.g*0.2));
                ...
                float2 node_8308 = (node_6686+(float2(cos(node_938),sin(node_938))*_ForceDistoTexture)+node_877);
                ...
                return fixed4(finalColor,(_MyOpacity*1.5));
            }
            ENDCG
        }
        Pass {
