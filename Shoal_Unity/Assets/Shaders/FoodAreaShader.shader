...
////// Emissive:
                ...
                float node_9757 = 1.0;
                float node_3198 = 0.5;
                float3 node_6822 = lerp(node_5656,lerp(node_5656,node_6553,node_8126),(1.0 - cos(((node_6011 + ( (node_1719 - node_4232) * (node_9757 - node_6011) ) / (node_5235 - node_4232))*3.141592654*node_3198)))); // HalfInside
                ...
                float3 emissive = lerp(_Color1.rgb,lerp(_Color2.rgb,_Color1.rgb,_Perlin_var.r),saturate(lerp((node_6372_if_leA*node_5656)+(node_6372_if_leB*node_6974),node_6974,node_6372_if_leA*node_6372_if_leB).r));
