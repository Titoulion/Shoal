...
////// Lighting:
////// Emissive:
                float3 node_5112 = lerp(_ColorGlobal4.rgb,_ColorGlobal5.rgb,_ProgressTouch);
                float node_3469 = 0.0;
                float node_6225 = 1.2;
                ...
                float3 emissive = lerp(node_5112,lerp(_ColorGlobal.rgb,node_5112,_Perlin_var.r),saturate(lerp((node_6372_if_leA*node_7484)+(node_6372_if_leB*node_6974),node_6974,node_6372_if_leA*node_6372_if_leB).r));
