...
////// Emissive:
                ...
                float3 emissive = saturate(( lerp(_ColorCentre.rgb,lerp(_OutsideColor2.rgb,_OutsideColor1.rgb,_Perlin2_var.r),node_2414) > 0.5 ? (1.0-(1.0-2.0*(lerp(_ColorCentre.rgb,lerp(_OutsideColor2.rgb,_OutsideColor1.rgb,_Perlin2_var.r),node_2414)-0.5))*(1.0-_Ramp_var.rgb)) : (2.0*lerp(_ColorCentre.rgb,lerp(_OutsideColor2.rgb,_OutsideColor1.rgb,_Perlin2_var.r),node_2414)*_Ramp_var.rgb) ));
                ...
                float node_1436 = 0.0;
                float node_2390 = 1.0;
                float node_2879 = ((node_1436 + ( (node_1888 - _StartFadeValue) * (node_2390 - node_1436) ) / (node_3957 - _StartFadeValue))*3.141592654*0.5);
                float node_1255 = 0.0;
                ...
                return fixed4(finalColor,(TheAlpha( node_5097 , node_7536 , lerp(node_7536,node_9422,(1.0 - cos(node_2879))) , lerp(node_9422,node_1255,sin(((node_1436 + ( (node_1888 - node_3957) * (node_2390 - node_1436) ) / (node_2390 - node_3957))*3.141592654*0.5))) , node_1255 , _StartFadeValue , node_3957 )*_Mask_var.r));
            }
            ENDCG
        }
        Pass {
