...
Shader "Shader Forge/SwirlHole" {
    Properties {
        ...
        _node_4134 ("node_4134", Float ) = 0
        _ProgressOpen ("ProgressOpen", Range(0, 1)) = 0
    ...
    SubShader {
        ...
        Pass {
            ...
            uniform float _node_4134;
            uniform float _ProgressOpen;
...
////// Emissive:
                ...
                float2 node_1663 = float2(((node_919 + ( (_ProgressOpen - node_3865) * ((-0.2) - node_919) ) / (1.0 - node_3865))+node_1719),0.5);
                float4 _Ramp_var = tex2D(_Ramp,TRANSFORM_TEX(node_1663, _Ramp));
                float4 node_7789 = _Time + _TimeEditor;
                float node_7520_ang = ((_node_2184*node_7789.g)+(node_5097*_node_4134));
                ...
                float3 emissive = saturate(( lerp(_ColorGlobal.rgb,lerp(_OutsideColor2.rgb,_OutsideColor1.rgb,_Perlin2_var.r),node_2414) > 0.5 ? (1.0-(1.0-2.0*(lerp(_ColorGlobal.rgb,lerp(_OutsideColor2.rgb,_OutsideColor1.rgb,_Perlin2_var.r),node_2414)-0.5))*(1.0-_Ramp_var.rgb)) : (2.0*lerp(_ColorGlobal.rgb,lerp(_OutsideColor2.rgb,_OutsideColor1.rgb,_Perlin2_var.r),node_2414)*_Ramp_var.rgb) ));
