...
Shader "Shader Forge/SwirlHole" {
    Properties {
        ...
        _ProgressRotation ("ProgressRotation", Float ) = 0
        _IntensitySwirl ("IntensitySwirl", Float ) = 0
    ...
    SubShader {
        ...
        Pass {
            ...
            uniform float _ProgressRotation;
            uniform float _IntensitySwirl;
...
////// Emissive:
                ...
                float node_7520_ang = (_ProgressRotation+(node_5097*_IntensitySwirl));
