...
////// Emissive:
                ...
                float3 emissive = (lerp(_ColorWaves.rgb,float3(1,1,1),saturate(floor(saturate((_Perlin4_var.r+_TransparenceWaves)) * _PosterizationWaves) / (_PosterizationWaves - 1)))+lerp(((_ColorBlendRamp.rgb*3.0)-_Ramp_var.rgb),_Render_var.rgb,node_2414)-1.0);
