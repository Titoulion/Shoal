...
Shader "Shader Forge/ToileShader" {
    Properties {
        ...
        [MaterialToggle] _UseGlobalOpacity ("UseGlobalOpacity", Float ) = 1
    ...
    SubShader {
        ...
        Pass {
            ...
            uniform fixed _UseGlobalOpacity;
            struct VertexInput {
...
////// Emissive:
                ...
                float3 emissive = lerp(lerp(_ColorGlobal3.rgb,float3(1,1,1),node_2039),lerp(((_ColorBlendRamp.rgb*3.0)-_Ramp_var.rgb),_Render_var.rgb,node_2414),saturate((lerp((node_9581_if_leA*node_6473)+(node_9581_if_leB*node_2039),node_6473,node_9581_if_leA*node_9581_if_leB)+0.8)));
                float3 finalColor = emissive;
                float node_5442 = 1.0;
                float node_2866_if_leA = step(node_5097,node_5442);
                float node_2866_if_leB = step(node_5442,node_5097);
                float node_4484 = 0.0;
                return fixed4(finalColor,((node_2414*lerp((node_2866_if_leA*node_5442)+(node_2866_if_leB*node_4484),node_4484,node_2866_if_leA*node_2866_if_leB))*lerp( 1.0, _GlobalOpacity, _UseGlobalOpacity )));
            }
            ENDCG
        }
    }
