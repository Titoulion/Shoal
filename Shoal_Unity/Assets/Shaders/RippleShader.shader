    ...
    SubShader {
        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
                ...
                float node_2101 = (_Progress*_SizeMax);
                float node_5062 = 1.0;
                float3 node_7837 = ((mul( _World2Object, float4(mul(_Object2World, v.vertex).rgb,0) ).xyz.rgb-objPos.rgb)*(node_2101-node_5062));
                v.vertex.xyz += node_7837;
...
////// Emissive:
                ...
                float3 emissive = lerp(float3(_TextureWave_var.r,_TextureWave_var.r,_TextureWave_var.r),_node_1954.rgb,_node_5058.rgb);
