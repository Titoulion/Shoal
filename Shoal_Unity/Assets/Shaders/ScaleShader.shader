...
////// Emissive:
                ...
                float3 node_6920 = lerp(lerp(lerp(node_658,node_2835,_PointCurve),_CustomColorA.rgb,_UseCustomGradient_var),lerp(lerp(node_2835,node_658,_PointCurve),_CustomColorB.rgb,_UseCustomGradient_var),floor(saturate((((1.0 - _ExchangeColor)*2.0+-1.0)+_Perlin_var.r)) * _PosterizeValue) / (_PosterizeValue - 1));
                float3 emissive = lerp(node_6920,saturate((lerp(node_6920,dot(node_6920,float3(0.3,0.59,0.11)),1.0)+float3(0.2,0.2,0.2))),_Hunger);
