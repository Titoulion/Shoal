...
////// Emissive:
                ...
                float3 emissive = lerp(lerp( lerp(lerp(node_658,node_2835,_PointCurve),lerp(node_2835,node_658,_PointCurve),floor(saturate((((1.0 - _ExchangeColor)*2.0+-1.0)+_Perlin_var.r)) * _PosterizeValue) / (_PosterizeValue - 1)), _myCustomColor.rgb, _UseCustomGradient ),dot(lerp( lerp(lerp(node_658,node_2835,_PointCurve),lerp(node_2835,node_658,_PointCurve),floor(saturate((((1.0 - _ExchangeColor)*2.0+-1.0)+_Perlin_var.r)) * _PosterizeValue) / (_PosterizeValue - 1)), _myCustomColor.rgb, _UseCustomGradient ),float3(0.3,0.59,0.11)),_Hunger);
                ...
                float node_6027 = 0.0;
                return fixed4(finalColor,((node_9866 + ( (_Hunger - node_956) * (_minAlpha - node_9866) ) / (1.0 - node_956))*lerp((node_7571_if_leA*node_7417)+(node_7571_if_leB*node_6027),node_6027,node_7571_if_leA*node_7571_if_leB)));
            }
            ENDCG
        }
        Pass {
